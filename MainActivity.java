...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m[0]=MediaPlayer.create(this,R.raw.wronganswer);
        m[1]=MediaPlayer.create(this,R.raw.ihy);
        m[2]=MediaPlayer.create(this,R.raw.lesstalkmoresolve);
        m[3]=MediaPlayer.create(this,R.raw.sillysue);
        m[4]=MediaPlayer.create(this,R.raw.micdrop);
